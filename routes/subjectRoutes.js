...
// Import Controller
const { createSubject, getAllSubjects, deleteSubject, getSubjectsByStudent, singleSubject, getSubjectsAssignedToTeacher, getStudentsBySubject } = require('../controllers/subjectController');
